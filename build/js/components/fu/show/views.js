(function() {
  ...
  define(['components/fu/show/templates', 'marionette', 'msgbus', 'moment'], function(Templates, Marionette, msgBus, Moment) {
    var FUCompositeView, FuEmpty, FuItem, _Layout;
    FuItem = (function(_super) {
      __extends(FuItem, _super);

      function FuItem() {
        return FuItem.__super__.constructor.apply(this, arguments);
      }
    ...
    FuEmpty = (function(_super) {
      ...
      function FuEmpty() {
        return FuEmpty.__super__.constructor.apply(this, arguments);
      }
    ...
    return {
      UploadView: FUCompositeView = (function(_super) {
        ...
        function FUCompositeView() {
          return FUCompositeView.__super__.constructor.apply(this, arguments);
        }
        ...
        FUCompositeView.prototype.initialize = function(options) {
          ...
          return msgBus.events.on("fu:errorAddingFile", (function(_this) {
            return function(err) {
