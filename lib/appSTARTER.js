...
Module dependencies.
 */
var MongoStore, apiController, app, connectAssets, contactController, day, express, expressValidator, flash, homeController, hour, mongoose, month, passport, passportConf, path, secrets, userController;
...
app.use(function(req, res, next) {
  ...
  if (/(auth|login|logout|signup)$/.test(path)) {
    return next();
  }
